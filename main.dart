...
import 'package:myfinalapp/AddEditPage.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future getData()async{
    var url = Uri.parse('http://192.168.1.8/php_mysql_crud/read.php');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: Text('php MySql App'),
        ),
        floatingActionButton: FloatingActionButton(
          child: Icon(Icons.add),
          onPressed: (){

            debugPrint('Clicked Floating Action Button');
          },
        ),
        body: FutureBuilder(
          future: getData(),
